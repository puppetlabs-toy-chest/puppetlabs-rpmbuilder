define rpmbuilder::mock::pe_mockset (
  ...
  rpmbuilder::mock::pe_mock { "pupent-${name}-el4-i386":      pe_ver  => $name, release => '4', arch => 'i386', mock_root => $mock_root, }
  rpmbuilder::mock::pe_mock { "pupent-${name}-el4-x86_64":    pe_ver  => $name, release => '4', arch => 'x86_64', mock_root => $mock_root, }
  ...
  rpmbuilder::mock::pe_mock { "pupent-${name}-sles10-i386":   pe_ver  => $name, dist => "sles", release => '10', sp => 'sp4', arch => 'i386', mock_root => $mock_root, }
